...
export class show_model{
	constructor(option={}) {
		...
		let confirmColor=option.confirmColor||'#DD196D';
	...
	creatView(style,opa,clickEvent,modelInfo){
		...
		view.draw([
		    ...
		    {tag:'font',id:'title',text:modelInfo.tit,textStyles:{size:'16px',color:'#000'},position:{top:this.pageHeight*0.435+'px',left:'20%',width:'60%',height:'4%'}},
