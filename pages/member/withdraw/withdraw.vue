...
export default {
	...
	onShow() {
		...
		if (this.$store.state.myCardInfo.id) {
			...
			this.bankCardNo = this.$store.state.myCardInfo.bankCardNo.substring(this.$store.state.myCardInfo.bankCardNo.length - 4, this.$store.state.myCardInfo.bankCardNo.length);
		}
