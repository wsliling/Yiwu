	...
	<view>
		<view class="topbox">
			<view class="userbox flex-start">
				<view class="tx">
					<image src="http://m.dance-one.com/static/my/user.png" mode="aspectFill" v-if="!info.avatar"></image>
			...
			<view class="icon-menu">
				 <view class="item">
					 <image class="icon" src="http://m.dance-one.com/static/my/v1.png"></image>
					 <text class="txt">开直播</text>
				 </view>
				 <view class="item">
					 <image class="icon" src="http://m.dance-one.com/static/my/v2.png"></image>
					 <text class="txt">开课程</text>
				 </view>
				 <view class="item">
					<image class="icon" src="http://m.dance-one.com/static/my/v3.png"></image>
					<text class="txt">上传舞曲</text>
				 </view>
				 <view class="item">
					 <image class="icon" src="http://m.dance-one.com/static/my/v4.png"></image>
