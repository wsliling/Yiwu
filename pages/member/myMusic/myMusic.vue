<template>
	<view>
		<view v-if="false" class="head" :style="{'padding-top':barHeight+'px'}">
			...
			<!-- #endif --> 
			<view class="head_r">
				<image src="http://m.dance-one.com/static/playmusic.png" class="iconimg"></image>
			</view>
		</view> 
		...
		<view class="menulist">
			<view class="item flex-between" v-for="(item,index) in datalist" :key="index" @click="tolink('/pages/member/myMusic_list/myMusic_list?id='+item.Id)">
				<view class="imgbox"><image :src="item.Img || 'http://m.dance-one.com/static/default_music.png'" mode="aspectFill"></image></view>
