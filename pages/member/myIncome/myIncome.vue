		...
		<view class="line-list">
			<view class="line-item line-arrow-r" v-if="IsShop == 1" @click="tolink('/pages/member/incomeDetails/incomeDetails?type=0')">
				<view class="line-item-l flex-start">
					<image class="iconimg" src="http://m.dance-one.com/static/my/shop.png" mode="widthFix"></image>
...
<style lang="scss" scoped>
	.walletbox{
		...
		.reveal{
			...
			height: 300upx;
			border-radius:30upx;
			background:url(http://m.dance-one.com/static/my/bg2.png);
