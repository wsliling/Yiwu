...
new _vuex.default.Store({
  ...
  mutations: {
    ...
    // 设置选择银行名称
    setSelectCard: function setSelectCard(state, params) {
      state.selectCard = params;
    },
    // 设置选择我的银行卡
    setSelectMyCard: function setSelectMyCard(state, params) {
...
/* 19 */
/*!***********************************!*\
  !*** D:/CODE/Yiwu/common/util.js ***!
  \***********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.formatTime = formatTime;exports.formatLocation = formatLocation;exports.toLogin = toLogin;exports.getCurrentPageUrlWithArgs = getCurrentPageUrlWithArgs;exports.getStorageOpenid = getStorageOpenid;exports.valPhone = valPhone;exports.getUrlParam = getUrlParam;exports.navigate = navigate;exports.uncodeUtf16 = uncodeUtf16;Object.defineProperty(exports, "get", { enumerable: true, get: function get() {return _request.get;} });Object.defineProperty(exports, "post", { enumerable: true, get: function get() {return _request.post;} });Object.defineProperty(exports, "requestHideLoading", { enumerable: true, get: function get() {return _request.requestHideLoading;} });exports.host = exports.dateUtils = void 0;
...
var _request = __webpack_require__(/*! ./request.js */ 20); // const host = 'http://ddypapi.wtvxin.com/api/';  //测试接口地址
...
function valPhone(tel) {var r_phone = /^[1][3,4,5,6,7,8,9][0-9]{9}$/; // var phoneNumber = $.trim($('#phoneNumber').val());
  if (tel == "") {uni.showToast({ title: "手机号不能为空!", icon: "none", duration: 2000 });return false;}if (!r_phone.test(tel)) {uni.showToast({ title: "请输入正确的手机格式!", icon: "none", duration: 2000 });return false;}return true;}function getUrlParam(name) {var reg = new RegExp("(^|&)" + name + "=([^&]*)(&|$)");var url = window.location.search.substr(1); //.toLowerCase();
...
var _util = __webpack_require__(/*! ./util.js */ 19);
...
function request(url, method, data) {
  ...
  return new Promise(function (resolve, reject) {
    uni.request({
      url: _util.host + url, //仅为示例，并非真实的接口地址
      method: method,
      data: data,
      header: {
